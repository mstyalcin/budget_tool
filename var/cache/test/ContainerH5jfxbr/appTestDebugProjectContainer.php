...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            'appbundle\\controller\\budgetcontroller' => 'AppBundle\\Controller\\BudgetController',
            'appbundle\\controller\\initiativecontroller' => 'AppBundle\\Controller\\InitiativeController',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\BudgetController' => __DIR__.'/getBudgetControllerService.php',
            'AppBundle\\Controller\\InitiativeController' => __DIR__.'/getInitiativeControllerService.php',
            ...
            'app.budget_checking_service' => __DIR__.'/getApp_BudgetCheckingServiceService.php',
...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('kz4TZPx8dR', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bx8TSDyon+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zIB9VLM4EY', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cpw0O33zhK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WGNiBhP6iB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c4d2d3775799ea5708827d7d7cada9f8a2d8e695')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c4d2d3775799ea5708827d7d7cada9f8a2d8e695');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'budget_tool',
            'database_user' => 'ftw',
            'database_password' => 'fetewe',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'mailer@mail.com',
            'mailer_password' => NULL,
            'secret' => 'c4d2d3775799ea5708827d7d7cada9f8a2d8e695',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'c4d2d3775799ea5708827d7d7cada9f8a2d8e695',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'mailer@mail.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'mailer@mail.com' => 'mailer@mail.com',
            ),
