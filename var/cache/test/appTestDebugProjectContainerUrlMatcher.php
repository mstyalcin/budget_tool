...
class appTestDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // homepage
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'AppBundle\\Controller\\LoginController::loginAction',  '_route' => 'homepage',);
            if (substr($pathinfo, -1) !== '/') {
        ...
        // new_budget
        if ('/new_budget' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\BudgetController::newBudgetAction',  '_route' => 'new_budget',);
        }
