...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/new_initiative'), array(0 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/new_budget'), array(0 => 'ROLE_ADMIN'), NULL);
